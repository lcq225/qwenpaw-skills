...
| 技能 | 版本 | 说明 | 安装 |
|------|:----:|------|------|
| [data-analysis](skills/data-analysis/README.md) | 1.0.1 | 通用数据分析：文件/数据库/粘贴→诊断+EDA+多维下钻+同环比→Markdown/HTML报告 | `qwenpaw skills install <release-url>/Data-Analysis-v1.0.1.zip` |
